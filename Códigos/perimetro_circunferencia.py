...
if obj and obj.type == 'MESH':
    ...
    quant_vert = len(obj.data.vertices)
    ...
    # calculando a distancia entre o primeiro e o ultimo ponto (para fechar a volta
    # inteira na circunferencia)
    x1,y1,z1 = coord_x[0], coord_y[0], coord_z[0]
    x2,y2,z2 = coord_x[quant_vert-1], coord_y[quant_vert-1], coord_z[quant_vert-1]
